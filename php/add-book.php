 ...
 include "func-validation.php";
  ...
  include "func-file-upload.php";
    ...
    $ms = "error";
     ...
     # if error occurs while uploading the book cover
     ...
     # if error occurs while uploading the file
     if($file['status']== "error"){
        ...
        #This will help get the new file name and book cover name
        $file_URL = $file['data'];
     ...
     $res = $stmt->execute([$title,$author,
     $description, $category, $book_cover_URL, $file_URL ]);
